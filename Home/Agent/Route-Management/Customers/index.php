...
<!-- Last Update: 3/32/15 -->
<!-- Agent Dashboard Page | Route Management | Customers-->
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Route Management For <?php echo $_GET['routeName']?></h1>
        <!-- START MANAGE SUBSCRIPTIONS FOR CUSTOMER $_GET['customerID']-->   
        <?php
          include("../../../../utilities/ui/manageCustomersOnRoute.php");
        ?>
